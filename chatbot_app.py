...
def qa_llm():
    ...
    # Create a Chroma instance without client_settings
...
def main():
    ...
    st.markdown("<h3 style='text-align: center; color: grey;'>Built by <a href='https://github.com/banik-s'>banik-s ❤️ </a></h3>", unsafe_allow_html=True)
